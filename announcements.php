                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="muted pull-left">Announcements</div>
                            </div>
					...
					while($row = ($query->fetch_assoc())){
						...
						if ($loc == '0'){
							...
							$link = "<hr/><a href='uploads/$loc'><button class='btn btn-success'><i class='icon icon-download'></i> Download Attachment</button></a>";
							
						}
					?>	<div class="post" >
					<div class="message_content">
					<?php echo $row['msg'].$link; ?>
					</div>

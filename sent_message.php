...
<?php include('session.php'); ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('supervisor_message_sidebar.php'); ?>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								 $query_announcement = mysqli_query($GLOBALS["___mysqli_ston"], "select * from message_sent
																	LEFT JOIN supervisor ON supervisor.supervisor_id = message_sent.reciever_id
